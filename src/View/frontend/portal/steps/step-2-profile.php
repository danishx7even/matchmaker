        ...
        <div class="profile-content-grid">
            <aside class="photo-sidebar">
                <div class="main-photo-frame">
                    ...
                    <img src="<?php echo esc_url($active_match['photo'] ?: get_avatar_url(0, ['size' => 600])); ?>" alt="<?php echo esc_attr($active_match['name']); ?>" class="mm-lightbox-trigger" data-mm-lightbox="potential-match-photo" style="cursor:zoom-in;" title="<?php esc_attr_e('Click to view full photo', 'matchmaker'); ?>" onclick="if(window.MM_openLightbox){window.MM_openLightbox(this);return false;}">
                </div>
