...
// =============================================================================
// Global helper functions — always loaded before class autoloading
// =============================================================================
...
if (!function_exists('mm_enqueue_user_matching_job')) {
     ...
     * deduplication) with stale-action clearing so a profile update always triggers
     * a fresh run.
     *
     ...
     *                        admin_manual_trigger | idle_recurring.
     * @return void
     */
    function mm_enqueue_user_matching_job(int $user_id, string $trigger): void
    {
        ...
        $hook  = \Matchmaker\Core\MatchingEngine::AS_MATCH_ACTION;
